...
public class DangNhapJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icon_lock_screen.jpg"))); // NOI18N
    ...
    private void btnSubmitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSubmitMouseClicked
        ...
        if (jtfTenDangNhap.getText().length() == 0 || jtfMatKhau.getText().length() == 0) {
                    ...
                    TaiKhoan taiKhoan = taiKhoanDao.login(jtfTenDangNhap.getText(), jtfMatKhau.getText());
                    if (taiKhoan == null) {
